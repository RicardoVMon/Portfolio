		...
		<section className="py-12 md:py-20 px-4 bg-white">
			<div className="max-w-3xl mx-auto text-center">
				...
				>
					...
					Whether you have an idea to share or just want to say hello, feel free to reach out.
				</motion.p>
				...
				>
					<a
						href="mailto:ricardovm2803@gmail.com"
				...
				>
					<a
						href="https://github.com/RicardoVMon"
						target="_blank"
					...
					<a
						href="https://www.linkedin.com/in/ricardovm2003/"
						target="_blank"
						rel="noopener noreferrer"
						className="p-2 bg-gray-100 text-gray-800 rounded-full hover:bg-gray-200 transition-colors"
					>
